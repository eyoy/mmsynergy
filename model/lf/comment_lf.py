...
save_path = '/mnt/g/mmsynergy/model/tune/lf/comment/'
        ...
        for hid in hid_dims:
            for hidhid in hidhid_dims:
                ...
                traindata, validdata, test_robust = \
                    get_dataloader( '/mnt/g/mmsynergy/model/data/comment_noplay.pkl', robust_test=False, batch_size = bz, max_seq_len=50)

                # mosi/mosei
                # encoders = [LSTM(272, 60, dropoutp=0.02).cuda(),
                #             LSTM(53, 400,dropoutp=0.03).cuda()]
                encoders = [Transformer(272, hid).cuda(),
                            Transformer(53, hid).cuda()]
