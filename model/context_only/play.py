...
save_path = '/mnt/g/mmsynergy/model/tune/context_only/play/'

lr_box = [0.0001, 0.0005, 0.001, 0.005]
bz_box = [16, 32, 64, 128]
hid_dims = [40]
hidhid_dims = [512]
modality_num = 2
        ...
        for hid in hid_dims:
            for hidhid in hidhid_dims:
                ...
                traindata, validdata, testdata = get_dataloader(
                    '/mnt/g/mmsynergy/model/data/play_contextual_censored.pkl', robust_test=False, max_pad=True, data_type='mosi', 
