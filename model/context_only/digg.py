...
save_path = '/mnt/g/mmsynergy/model/tune/context_only/digg/'
        ...
        for hid in hid_dims:
            for hidhid in hidhid_dims:
                ...
                traindata, validdata, testdata = get_dataloader(
                    '/mnt/g/mmsynergy/model/data/digg_contextual_censored.pkl', robust_test=False, max_pad=True, data_type='mosi', 
