...
save_path = '/mnt/g/mmsynergy/model/tune/uni_a/comment/'
    ...
    for bz in bz_box:
        for hid in hid_dims:
            for hidhid in hidhid_dims:
                ...
                # mosi/mosei
                encoder = Transformer(53, hid).cuda()
                ...
                encoder = torch.load(save_path+'models/encoder_uni_a_lr0.0001_bs16_hid40_hidhid512.pt'.format(lr,bz,hid,hidhid)).cuda()
                head = torch.load(save_path+'models/head_uni_a_lr0.0001_bs16_hid40_hidhid512.pt'.format(lr,bz,hid,hidhid))
