...
from fusions.mult.mult_mtl_contextual_768 import MULTModel 
...
#save_path = '/mnt/f/erya/mmsynergy/model/tune/mult_mtl_contextual/'
save_path = '/mnt/g/mmsynergy/model/tune/temp/'
seed = 521
lr_box = [5e-3,5e-2,1e-4, 1e-3, 1e-2]
bz_box = [256]
