...
save_path = '/mnt/g/mmsynergy/model/tune/uni_v_context/comment/'

lr_box = [0.001,0.005, 0.0005, 0.0001, 0.00001]
bz_box = [16, 32, 64, 128]
hid_dims = [40]
hidhid_dims = [512]
for lr in lr_box:
        ...
        for hid in hid_dims:
            for hidhid in hidhid_dims:
                ...
                traindata, validdata, test_robust = \
                    get_dataloader( '/mnt/g/mmsynergy/model/data/comment_contextual_censored.pkl', robust_test=False, batch_size = bz, max_seq_len=50)
