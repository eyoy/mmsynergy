...
from fusions.mult.mult_modified_nocross import MULTModel  # noqa
...
save_path = '/mnt/g/mmsynergy/model/tune/mult_nocmt/comment_nocmt/'
seed = 521
bz_box = [16, 32, 128]
#seq_box = [40]
#heads_box = [10]
...
for bz in bz_box:
        for lr in lr_box:
                ...
                traindata, validdata,  test_robust = get_dataloader('/mnt/g/mmsynergy/model/data/comment_noplay.pkl', robust_test=False, max_pad=True, batch_size=bz,max_seq_len=50, num_workers=0)
                ...
                model = torch.load(save_path+'models/lr0.0005_bs32.pt').cuda()
