...
save_path = '/mnt/g/mmsynergy/model/tune/mult_nocmt/play_nocmt/'
seed = 521
bz_box = [16, 32, 64, 128]
#seq_box = [40]
#heads_box = [10]
...
for bz in bz_box:
        for lr in lr_box:
                ...
                traindata, validdata,  test_robust = get_dataloader('/mnt/g/mmsynergy/model/data/play.pkl', robust_test=False, max_pad=True, batch_size=bz,max_seq_len=50, num_workers=0)
