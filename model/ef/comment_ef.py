...
save_path = '/mnt/g/mmsynergy/model/tune/ef/comment/'
outputs = ['comment']
        ...
        for bz in bz_box:
            for hid in hid_dims:
                for hidhid in hidhid_dims:
                    ...
                    '/mnt/g/mmsynergy/model/data/comment_noplay.pkl', robust_test=False, max_pad=True, batch_size=bz,max_seq_len=50)
                    # # mosi/mosei
