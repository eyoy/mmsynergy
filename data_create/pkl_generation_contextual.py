...
continuous = d[['age','follower', 'following', 'like','video', 'duration', 'timestamp']].to_numpy() # N x 7
...
with open('/mnt/g/mmsynergy/model/data/digg_contextual.pkl', 'wb') as f:
    pickle.dump(digg, f)
print('/mnt/g/mmsynergy/model/data/digg_contextual.pkl')
# with open('/mnt/e/erya/mult_rr_data/new_0115/share.pkl', 'wb') as f:
#     pickle.dump(share, f)
# print('/mnt/e/erya/mult_rr_data/new_0115/share.pkl')
with open('/mnt/g/mmsynergy/model/data/comment_contextual.pkl', 'wb') as f:
    pickle.dump(comment, f)
print('/mnt/g/mmsynergy/model/data/comment_contextual.pkl')
# with open('/mnt/e/erya/mult_rr_data/new_0115/play.pkl', 'wb') as f:
#     pickle.dump(play, f)
# print('/mnt/e/erya/mult_rr_data/new_0115/play.pkl')
with open('/mnt/g/mmsynergy/model/data/mtl_contextual.pkl', 'wb') as f:
    pickle.dump(mtl, f)
print('/mnt/g/mmsynergy/model/data/mtl_contextual.pkl')
