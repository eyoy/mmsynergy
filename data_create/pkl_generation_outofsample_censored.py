...
#data generated
digg  = {'train':{'vision':visual_train, 'audio':audio_train, 'text': contextual_train, 'id':ids_train, 'labels':digg_train, 'label_p': play_train},
        'valid':{'vision':visual_valid, 'audio':audio_valid, 'text': contextual_valid,'id':ids_valid, 'labels':digg_valid, 'label_p': play_valid},
        'test':{'vision':visual_test, 'audio':audio_test, 'text':contextual_test, 'id':ids_test, 'labels':digg_test, 'label_p': play_test}}
...
comment = {'train':{'vision':visual_train, 'audio':audio_train, 'text':contextual_train, 'id':ids_train, 'labels':comment_train, 'label_p': play_train},
        'valid':{'vision':visual_valid, 'audio':audio_valid, 'text': contextual_valid, 'id':ids_valid, 'labels':comment_valid, 'label_p': play_valid},
        'test':{'vision':visual_test, 'audio':audio_test, 'text':contextual_test, 'id':ids_test, 'labels':comment_test, 'label_p': play_test}}
...
with open('/mnt/g/mmsynergy/outofsample/data/pkl/digg_context785.pkl', 'wb') as f:
    pickle.dump(digg, f)
print('/mnt/g/mmsynergy/outofsample/data/pkl/digg_context785.pkl')
# with open('/mnt/e/erya/mult_rr_data/new_0115/share.pkl', 'wb') as f:
#     pickle.dump(share, f)
# print('/mnt/e/erya/mult_rr_data/new_0115/share.pkl')
with open('/mnt/g/mmsynergy/outofsample/data/pkl/comment_context785.pkl', 'wb') as f:
    pickle.dump(comment, f)
print('/mnt/g/mmsynergy/outofsample/data/pkl/comment_context785.pkl')
# with open('/mnt/e/erya/mult_rr_data/new_0115/play.pkl', 'wb') as f:
#     pickle.dump(play, f)
# print('/mnt/e/erya/mult_rr_data/new_0115/play.pkl')
with open('/mnt/g/mmsynergy/outofsample/data/pkl/mtl_context785.pkl', 'wb') as f:
    pickle.dump(mtl, f)
print('/mnt/g/mmsynergy/outofsample/data/pkl/mtl_context785.pkl')
