...
print(len(visual_id_train)+len(visual_id_valid)+len(visual_id_test))
with open ('/mnt/g/mmsynergy/outofsample/data/pkl/train_id.json', 'w') as f:
    json.dump(visual_id_train, f)
with open ('/mnt/g/mmsynergy/outofsample/data/pkl/valid_id.json', 'w') as f:
    json.dump(visual_id_valid, f)
with open ('/mnt/g/mmsynergy/outofsample/data/pkl/test_id.json', 'w') as f:
...
with open('/mnt/g/mmsynergy/outofsample/data/pkl/digg.pkl', 'wb') as f:
    pickle.dump(digg, f)
print('/mnt/g/mmsynergy/outofsample/data/pkl/digg.pkl')
# with open('/mnt/e/erya/mult_rr_data/new_0115/share.pkl', 'wb') as f:
#     pickle.dump(share, f)
# print('/mnt/e/erya/mult_rr_data/new_0115/share.pkl')
with open('/mnt/g/mmsynergy/outofsample/data/pkl/comment.pkl', 'wb') as f:
    pickle.dump(comment, f)
print('/mnt/g/mmsynergy/outofsample/data/pkl/comment.pkl')
# with open('/mnt/e/erya/mult_rr_data/new_0115/play.pkl', 'wb') as f:
#     pickle.dump(play, f)
# print('/mnt/e/erya/mult_rr_data/new_0115/play.pkl')
with open('/mnt/g/mmsynergy/outofsample/data/pkl/mtl.pkl', 'wb') as f:
    pickle.dump(mtl, f)
print('/mnt/g/mmsynergy/outofsample/data/pkl/mtl.pkl')
