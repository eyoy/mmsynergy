...
video_f_path = '/mnt/f/erya/mmsynergy/alphapose_2d_norm/'
text_f_path = '/mnt/f/erya/mmsynergy/bert/'
audio_json  = [audio_f_path+a for a in os.listdir(audio_f_path)]


clean_ids = [i.split('.mp4')[0] for i in os.listdir('/mnt/f/erya/mmsynergy/single_videos_cleaned/') if i.endswith('.mp4')]
print(len(clean_ids))
...
print(len(clean_ids))
beats = pd.read_csv('/mnt/f/erya/mmsynergy/music_beats_duration.csv', index_col=0)
...
print(len(visual_id_train)+len(visual_id_valid)+len(visual_id_test))
with open ('/mnt/f/erya/mmsynergy/model/train_id.json', 'w') as f:
    json.dump(visual_id_train, f)
with open ('/mnt/f/erya/mmsynergy/model/valid_id.json', 'w') as f:
    json.dump(visual_id_valid, f)
with open ('/mnt/f/erya/mmsynergy/model/test_id.json', 'w') as f:
...
text_train = np.array(text_box_train)
...
text_test = np.array(text_box_test)
...
text_valid = np.array(text_box_valid)
...
#data generated
digg  = {'train':{'vision':visual_train, 'audio':audio_train, 'text': text_train, 'id':ids_train, 'labels':digg_train, 'label_p': play_train},
        'valid':{'vision':visual_valid, 'audio':audio_valid, 'text': text_valid,'id':ids_valid, 'labels':digg_valid, 'label_p': play_valid},
        'test':{'vision':visual_test, 'audio':audio_test, 'text':text_test, 'id':ids_test, 'labels':digg_test, 'label_p': play_test}}
...
comment = {'train':{'vision':visual_train, 'audio':audio_train, 'text': text_train, 'id':ids_train, 'labels':comment_train, 'label_p': play_train},
        'valid':{'vision':visual_valid, 'audio':audio_valid, 'text': text_valid, 'id':ids_valid, 'labels':comment_valid, 'label_p': play_valid},
        'test':{'vision':visual_test, 'audio':audio_test, 'text':text_test, 'id':ids_test, 'labels':comment_test, 'label_p': play_test}}
...
mtl = {'train':{'vision':visual_train, 'audio':audio_train, 'text': text_train, 'id':ids_train, 'labels1':digg_train, 'labels2':comment_train,'label_p': play_train},
        'valid':{'vision':visual_valid, 'audio':audio_valid, 'text': text_valid, 'id':ids_valid, 'labels1':digg_valid, 'labels2':comment_valid, 'label_p': play_valid},
        'test':{'vision':visual_test, 'audio':audio_test, 'text':text_test, 'id':ids_test, 'labels1':digg_test, 'labels2':comment_test, 'label_p': play_test}}

with open('/mnt/f/erya/mmsynergy/model/data/digg.pkl', 'wb') as f:
    pickle.dump(digg, f)
print('/mnt/f/erya/mmsynergy/model/data/digg.pkl')
# with open('/mnt/e/erya/mult_rr_data/new_0115/share.pkl', 'wb') as f:
#     pickle.dump(share, f)
# print('/mnt/e/erya/mult_rr_data/new_0115/share.pkl')
with open('/mnt/f/erya/mmsynergy/model/data/comment.pkl', 'wb') as f:
    pickle.dump(comment, f)
print('/mnt/f/erya/mmsynergy/model/data/comment.pkl')
# with open('/mnt/e/erya/mult_rr_data/new_0115/play.pkl', 'wb') as f:
#     pickle.dump(play, f)
# print('/mnt/e/erya/mult_rr_data/new_0115/play.pkl')
with open('/mnt/f/erya/mmsynergy/model/data/mtl.pkl', 'wb') as f:
    pickle.dump(mtl, f)
print('/mnt/f/erya/mmsynergy/model/data/mtl.pkl')
