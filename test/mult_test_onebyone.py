...
traindata, vids_train, validdata, vids_valid, test_robust, vids = get_dataloader('/mnt/f/erya/mmsynergy/model/data/mtl.pkl', 
...
model = torch.load("/mnt/f/erya/mmsynergy/model/tune/mtl/models/mtl_lr0.0005_bs64_alpha0.4.pt")
...
for i in total:
     ...
     for id, data in i:
          ...
          np.savez('/mnt/f/erya/mmsynergy/matrix/{}.npz'.format(id), cos.detach().cpu())
          print("Successfully saved to /mnt/f/erya/mmsynergy/matrix/{}.npz".format(id))
...
df.to_csv('/mnt/f/erya/mmsynergy/regression/mtl.csv')
print("Saved!" + '/mnt/f/erya/mmsynergy/regression/mtl.csv')
