...
from fusions.mult.mult_mtl_contextual import MULTModel  # noqa
...
traindata, vids_train, validdata, vids_valid, test_robust, vids = get_dataloader('/mnt/g/mmsynergy/outofsample/data/pkl/mtl_context785.pkl', 
...
for i in total:
     ...
     for id, data in i:
          ...
          np.savez('/mnt/g/mmsynergy/outofsample/matrix/mult_mtl_contextual785/{}.npz'.format(id), cos.detach().cpu())
          print("Successfully saved to /mnt/g/mmsynergy/outofsample/matrix/mult_mtl_contextual785/{}.npz".format(id))
...
df.to_csv('/mnt/g/mmsynergy/outofsample/regression/mult_mtl_contextual785.csv')
print("Saved!" + '/mnt/g/mmsynergy/outofsample/regression/mult_mtl_contextual785.csv')
