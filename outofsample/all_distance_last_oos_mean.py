...
from dtw import *
# env multibench
data_path = '/mnt/g/mmsynergy/outofsample/matrix/mult_mtl_contextual785_matrix/'
...
for f in files:
    ...
    v_mean = np.mean(mat1, axis=0)
    #print(v_mean.shape)
    a_mean = np.mean(mat2, axis=0)
...
df.to_csv('/mnt/g/mmsynergy/outofsample/regression/all_dist_mtl_last_oos_contextual_mean.csv')
