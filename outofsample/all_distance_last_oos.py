...
from dtw import *
# env multibench
data_path = '/mnt/g/mmsynergy/outofsample/matrix/mult_mtl_contextual785/'
...
df.to_csv('/mnt/g/mmsynergy/outofsample/regression/all_dist_mtl_last_oos_contextual.csv')
